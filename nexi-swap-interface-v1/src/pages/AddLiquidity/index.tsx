...
import { Currency, currencyEquals, ETHER, TokenAmount, WETH } from '@nexiswap/sdk'
import { Button, CardBody, AddIcon, Text as UIKitText } from '@crytoswap-libs/uikit'
...
export default function AddLiquidity({
  ...
  const oneCurrencyIsWNEXI = Boolean(
    chainId &&
  ...
  const handleCurrencyBSelect = useCallback(
    (currB: Currency) => {
      ...
      if (currencyIdA === newCurrencyIdB) {
        ...
        history.push(`/add/${currencyIdA || 'NEXI'}/${newCurrencyIdB}`)
      }
    },
    ...
    <>
      ...
      {pair && !noLiquidity && pairState !== PairState.INVALID ? (
        <AutoColumn style={{ minWidth: '20rem', marginTop: '1rem' }}>
          <MinimalPositionCard showUnwrapped={oneCurrencyIsWNEXI} pair={pair} />
        </AutoColumn>
      ) : null}
    </>
  )
