...
import { Currency, currencyEquals, ETHER, Percent, WETH } from '@nexiswap/sdk'
import { Button, Flex, Text } from '@crytoswap-libs/uikit'
                      ...
                      {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                        <RowBetween style={{ justifyContent: 'flex-end' }}>
                          {oneCurrencyIsETH ? (
                            ...
                            >
                              {TranslateString(1188, 'Receive WNEXI')}
                            </StyledInternalLink>
                          ) : oneCurrencyIsWETH ? (
                            <StyledInternalLink
                              to={`/remove/${
                                currencyA && currencyEquals(currencyA, WETH[chainId]) ? 'NEXI' : currencyIdA
                              }/${currencyB && currencyEquals(currencyB, WETH[chainId]) ? 'NEXI' : currencyIdB}`}
                            >
                              {TranslateString(1190, 'Receive NEXI')}
                            </StyledInternalLink>
                          ) : null}
                        </RowBetween>
                      ) : null}
