...
import { Button, Text } from '@crytoswap-libs/uikit'
            ...
            <>
              ...
              <Text color="failure">
                {transactionType === 'Buying'
                  ? 'You will not receive CRYTOSW rewards for holding purchased SYRUP.'
                  : 'You will need to buy back the same amount of SYRUP to be able to convert back to CRYTOSW.'}
              </Text>
            </>
          )}
          <RowBetween>
